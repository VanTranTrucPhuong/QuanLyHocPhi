...
//        values.put(DBHelper.KEY_SUB_ORDER, subject.getId());
    ...
    public int updateSubject(Subject subject){
        ...
        contentValues.put(KEY_ID_SUB,subject.getSubject_id());
        ...
        return db.update(TABLE_NAME_SUB,contentValues,KEY_ID_SUB+"=?",new String[]{String.valueOf(subject.getId())});
    }
    ...
    public Subject fetchSubjectByID(int subject_id){
        ...
        Cursor cursor= db.query(TABLE_NAME_SUB,new String[]{DBHelper.KEY_ID_SUB, KEY_ID_SUB,DBHelper.KEY_NAME_SUB,DBHelper.KEY_CREDITNUMBER},DBHelper.KEY_ID_SUB+"=?",new String[]{String.valueOf(subject_id)},null,null,null);
        if(cursor!=null){
            cursor.moveToFirst();
        }
